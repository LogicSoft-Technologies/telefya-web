  ...
  return (
    <section className="relative overflow-hidden bg-white pt-8 sm:pt-12">
      ...
      <div className="relative mx-auto grid max-w-[92rem] items-center gap-10 px-4 pb-12 sm:gap-12 sm:px-5 sm:pb-16 lg:grid-cols-[0.82fr_1.18fr] lg:px-8">
        <div>
          <div className="telefya-in-fade-up inline-flex min-w-[150px] items-center justify-center rounded-md border border-blue-100 bg-blue-50 px-3 py-3.5 text-xs font-bold text-telefya-blue sm:min-w-[180px] sm:px-3.5 sm:py-5 sm:text-sm">
            <span key={rotatingLabels[labelIndex]} className="animate-[fadeSlide_0.4s_ease-out] text-center">
              {rotatingLabels[labelIndex]}
            </span>
          </div>

          <h1 className="telefya-in-fade-up telefya-stagger-1 mt-6 max-w-2xl text-[40px] font-black leading-[1.05] tracking-tight text-navy-900 sm:mt-8 sm:text-5xl sm:leading-[1.02] md:text-[58px]">
            One App. <br />
          ...
          <p className="telefya-in-fade-up telefya-stagger-2 mt-4 max-w-lg text-base leading-7 text-navy-500 sm:mt-5 sm:text-lg sm:leading-8">
          ...
          <div className="telefya-in-fade-up telefya-stagger-3 mt-7 flex flex-col gap-3 sm:mt-8 sm:flex-row">
            <a
              href="/register"
              className="telefya-interactive telefya-lift telefya-press telefya-focus-ring inline-flex items-center justify-center gap-2 rounded-md bg-telefya-violet px-6 py-3.5 text-sm font-bold text-white hover:bg-telefya-blue sm:py-3"
            >
            ...
            <a
              href="/contact-sales"
              className="telefya-interactive telefya-press telefya-focus-ring inline-flex items-center justify-center rounded-md border border-border bg-white px-6 py-3.5 text-sm font-bold text-navy-900 hover:border-telefya-blue hover:text-telefya-blue sm:py-3"
            >
              Book a demo
            </a>
          </div>

          <div className="telefya-in-fade-up telefya-stagger-4 mt-7 flex flex-wrap items-center gap-x-5 gap-y-2 text-xs font-semibold text-navy-400 sm:mt-8 sm:gap-6 sm:text-sm">
        ...
        <div className="telefya-in-scale telefya-stagger-2 relative">
          <div className="relative z-10 overflow-hidden rounded-lg bg-navy-900 shadow-enterprise">
            <div className="flex items-center justify-between border-b border-white/[0.06] px-3 py-4 text-white sm:px-4 sm:py-5">
              ...
              <div className="flex items-center gap-3 text-xs font-bold sm:gap-4">
                <span className="flex items-center gap-1.5 text-telefya-green">
                  <span className="telefya-pulse-dot h-1.5 w-1.5 rounded-full bg-telefya-green" />
                  Secure
                </span>
            ...
            <div className="grid gap-2 p-2.5 sm:p-3 lg:grid-cols-[1fr_210px]">
              <div className="grid grid-cols-2 gap-2">
                {people.map((person, index) => (
                  <div
                    key={person.name}
                    className={`telefya-in-scale telefya-stagger-${index + 1} relative h-32 overflow-hidden rounded-md bg-navy-700 sm:h-40 lg:h-[172px]`}
                  >
                    <img
                      src={person.image}
              ...
              <aside className="telefya-in-right telefya-stagger-5 flex flex-col rounded-md bg-white/[0.05] p-3.5 text-white sm:p-4">
                ...
                <div className="flex flex-1 flex-col gap-3">
                  {[
                    ...
                    <div
                      key={name}
                      className={`telefya-in-fade-up telefya-stagger-${index + 6}`}
                    >
                ...
                <div className="telefya-interactive mt-4 flex items-center gap-2 rounded-md border border-white/[0.08] bg-white/[0.05] px-3 py-2 hover:border-white/[0.16]">
                  <span className="flex-1 text-xs text-white/30">Message…</span>
                  <span className="telefya-interactive telefya-press grid h-6 w-6 place-items-center rounded-md bg-telefya-violet text-white">
                    <ArrowRight size={12} />
                  </span>
                </div>
              </aside>
            ...
            <div className="flex flex-wrap items-center justify-center gap-1.5 border-t border-white/[0.06] px-3 py-4 sm:gap-2 sm:px-4 sm:py-5">
              {controls.map((Icon, index) => (
                <button
                  key={index}
                  className="telefya-interactive telefya-press telefya-focus-ring grid h-9 w-9 place-items-center rounded-md bg-white/[0.06] text-white/65 hover:bg-white/[0.12] sm:h-10 sm:w-10"
                >
                  <Icon size={16} className="sm:hidden" />
                  <Icon size={17} className="hidden sm:block" />
                </button>
              ))}
              <button className="telefya-interactive telefya-press telefya-focus-ring grid h-9 w-9 place-items-center rounded-md bg-red-600 text-white hover:bg-red-700 sm:h-10 sm:w-10">
